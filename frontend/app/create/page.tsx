    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Please complete the setup wizard before creating campaigns.</p>
          <button
            onClick={() => router.push('/')}
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Design and launch a new marketing campaign</p>
      </div>
