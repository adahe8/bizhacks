...
export default function Home() {
        ...
        <div className="bg-white rounded-lg p-8 max-w-md w-full animate-fade-up shadow-lg">
          <div className="text-center">
            ...
            <div className="space-y-4">
              ...
              <button onClick={startNewSetup} className="btn-outline w-full">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50">
          ...
          <div className="max-w-4xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <h1 className="text-xl font-bold text-primary-600">
                BizHacks Setup Wizard
              </h1>
              <button
                onClick={() => {
                  if (
                    confirm("Are you sure you want to exit the setup wizard?")
                  ) {
                    if (isExistingSetup) {
                      router.push("/dashboard");
                    } else {
      ...
      <div
        className={currentStep && currentStep !== "ai-campaigns" ? "pt-16" : ""}
      >
        {currentStep === "firm" && (
          <FirmDetailsModal
            onComplete={(data) =>
              handleStepComplete({ company_id: data.company_id })
            }
          />
        )}
        ...
        {currentStep === "product" && (
          <ProductDetailsModal
            ...
            onComplete={(data) =>
              handleStepComplete({ product_id: data.product_id })
            }
          />
        )}
        ...
        {currentStep === "ai-campaigns" &&
          completedSetup && ( // ✅ Pass completedSetup
